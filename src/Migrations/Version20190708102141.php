 ...
 */
final class Version20190708102141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service ADD category_id INT DEFAULT NULL, ADD slug VARCHAR(128) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service DROP category_id, DROP slug');
    }
}
